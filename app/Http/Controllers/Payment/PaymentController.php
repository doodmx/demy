...
class PaymentController extends Controller
{
    ...
    )
    {
        ...
        //Get the client ID or store it in the payment gateway
        $customerId = null;
        if (isset($request['saveCustomer'])) {
            ...
            if (empty($partnerPaymentGateway)) {
                ...
                $customerId = $partnerPaymentGatewayContract
                    ->save(
                        auth()->user()->id,
                ...
                $customerId = $partnerPaymentGateway->uuid;
            }
        }

        ...
        <form id="appointmentForm" action="{{route('mails.appointment')}}">
           ...
           @csrf
            ...
            <div class="md-form form-group form-group-lg">
                ...
                />
                <label for="appointment-name" class="control-label font-weight-bold">
            ...
            <div class="md-form form-group form-group-lg">
                <input
                        ...
                        data-parsley-required="true"
                />
                <label for="appointment-lastname" class="control-label font-weight-bold">
            ...
            <div class="md-form form-group form-group-lg">
                ...
                <label for="appointment-email" class="control-label font-weight-bold">
                    {{__('web/forms.schedule')['fields']['email']['placeholder']}}
                </label>
            </div>

            <label for="contact-email" class="control-label text-primary font-weight-bold">

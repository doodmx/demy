...
<table class="invoice-header">
    <tr>
        ...
        <td class="brand">
            ...
            <img src="https://cdn.veltacorp.com/img/velta_corto.png" alt="Azell Logo">
            <div class="title">{{__('cart.invoice')}}</div>

        </td>
        <td class="company">
            <p>+521 427 1822 721</p>
            <p>finanzas@veltacorp.com</p>
            <p>
                {{__('cart.visit_us')}}<b> <a href="https://veltacorp.com">veltacorp.com</a></b>
            </p>
